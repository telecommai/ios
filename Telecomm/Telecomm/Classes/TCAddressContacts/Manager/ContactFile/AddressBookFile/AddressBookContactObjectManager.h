...
NS_CLASS_DEPRECATED_IOS(2_0, 9_0,"Use ContactObjectManager instead") @interface AddressBookContactObjectManager : NSObject
...
@interface AddressBookContactObjectManager (ABRecordRef)
