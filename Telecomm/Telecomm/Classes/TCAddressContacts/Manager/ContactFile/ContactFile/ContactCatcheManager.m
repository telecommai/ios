...
@interface ContactCatcheManager ()
...
@implementation ContactCatcheManager
...
+(instancetype)sharedInstace{
    static ContactCatcheManager * manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[ContactCatcheManager alloc]init];
    });
    return manager;
}
