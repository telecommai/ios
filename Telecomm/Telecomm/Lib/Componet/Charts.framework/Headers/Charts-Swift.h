...
SWIFT_CLASS("_TtC6Charts13BalloonMarker")
...
@property (nonatomic, strong) UIColor * _Nonnull strokeBackColor;
@end
...
/// 自定义属性，是否返回当前手势信息
@property (nonatomic) BOOL gestureInfoEnabled;
...
/// 自定义方法，得到当前触摸的手势
- (void)chatViewLongPressGestureRecognizer:(UIGestureRecognizer * _Nonnull)currentGestureRecognizer callDelegate:(BOOL)callDelegate;
///
/// returns:
...
/// 自定义方法，返回此刻的手势
- (void)chatViewLongPressGestureRecognizer:(ChartViewBase * _Nonnull)chartView currentGestureRecognizer:(UIGestureRecognizer * _Nonnull)currentGestureRecognizer;
/// 自定义方法，返回平移手势移动的x点
- (void)chatViewPanGestureRecognizer:(ChartViewBase * _Nonnull)chartView panGestureRecognizer:(UIGestureRecognizer * _Nonnull)panGestureRecognizer;
@end
