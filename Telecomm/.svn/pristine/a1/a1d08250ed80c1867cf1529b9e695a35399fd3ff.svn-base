...
@interface AddressBookContactManager ()
...
@implementation AddressBookContactManager
...
- (void)__obtainContactCompleteBlock:(void(^)(NSArray<RITLContactObject *> * _Nonnull)) completeBlock{
    ...
    for (NSInteger i = 0; i < count; i++){
        ...
        //获得contact对象
        RITLContactObject * contactObject = [AddressBookContactObjectManager contantObject:recordRef];
        //添加对象
